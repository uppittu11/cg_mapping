...
class State(object):
    ...
    def compute_bond_parameters(self, traj, atomtype_i, atomtype_j):
        ...
        fig, ax = plt.subplots(1,1)
        ax.plot(all_distances, predicted_energies, c='darkgray', label="Predicted")
    ...
    def compute_angle_parameters(self, traj, atomtype_i, atomtype_j, atomtype_k):
        ...
        fig, ax = plt.subplots(1,1)
        ax.plot(all_angles, predicted_energies, c='darkgray', label="Predicted")
        ax.plot(all_angles, all_energies, c='black', label="Target")
        ax.legend()
        ax.set_xlabel("Angle (rad)")
        ax.set_ylabel("Energy (kJ/mol)")
